  ...
  return (
    ...
    >
      <body className="min-h-full">
        ...
        {/*
          Page views and real-user Core Web Vitals. Both render nothing and
          ship their own Suspense boundary, so they sit in the server layout
          as-is. Both only report on Vercel — a no-op locally, and each has to
          be enabled separately in the project dashboard.
        */}
        <Analytics />
        <SpeedInsights />
      </body>
